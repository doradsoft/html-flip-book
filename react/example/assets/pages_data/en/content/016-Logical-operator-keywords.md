...
Logical Operators can be used for conditions as they show a result in form of a
`boolean` (True/False) or Unknown. So, e.g. if an exact value is `True` for a
value, a Logical Operator can proof that it's True.
